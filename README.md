# 🎨 Shadcn/UI Separator for Weweb

Beautiful **Separator component** from [shadcn/ui](https://ui.shadcn.com/) adapted for Weweb.

## 🚀 Import in Weweb

1. Copy this repository URL: `https://github.com/YOUR_USERNAME/shadcn-separator`
2. In Weweb editor, open developer panel (F12)
3. Add as "custom element"
4. The Separator component will appear in your elements!
...
├── src/
│   ├── Separator.vue    # Vue.js component
│   ├── cn.js            # CSS utility
